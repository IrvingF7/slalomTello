...
data.time                = values(:,2);
data.ref_yaw           = values(:,3);
data.control_leftRight   = values(:,4);
...
data.tvec_x      = values(:,24);
data.tvec_y      = values(:,25);
data.tvec_z      = values(:,26);
data.rvec_x      = values(:,27);
data.rvec_y      = values(:,28);
data.rvec_z      = values(:,29);
data.ref_x = values(:,30);
data.ref_y = values(:,31);
data.ref_z = values(:,32);
